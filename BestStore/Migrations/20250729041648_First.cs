    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, false, "Store Manager" },
                    { 2, 1, false, "Sales Executive" },
                    { 3, 1, false, "Online Sales Representative" },
                    { 4, 2, false, "Technical Support" },
                    { 5, 2, false, "Technical Website" },
                    { 6, 2, false, "Technical Hardware" },
                    { 7, 3, false, "Cashier" },
                    { 8, 3, false, "Accountant" },
                    { 9, 3, false, "Finance Analyst" },
                    { 10, 4, false, "Inventory Staff" },
                    { 11, 4, false, "Delivery Staff" },
                    { 12, 4, false, "Warehouse Coordinator" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 15, new DateTime(1993, 3, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 9, "james@example.com", 3, "James Minh", "Male", new DateTime(2021, 7, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), 62000m }
                });
